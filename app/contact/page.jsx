...
const info = [
  { icon: <FaPhoneAlt />, title: 'Phone', description: '(+250) 787 014 425' },
  { icon: <FaEnvelope />, title: 'Email', description: 'edwigeakuzwe6@gmail.com' },
  { icon: <FaMapMarkedAlt />, title: 'Address', description: 'RN3, Rwanda' }
];
